 ...
 */
class FramesetDTD extends StandardDTD {
	// *** Class Members ***
	...
	FramesetDTD(DTD parent) {
		...
		Name frame = XHTML.elementNameFor("frame");
		Name frameset = XHTML.elementNameFor("frameset");
		...
		AttributeDef a_cols = new AttributeDef(XHTML.attributeNameFor("cols"), AttributeDef.CDATA_TYPE, false);
		AttributeDef a_cols2 = new AttributeDef(XHTML.attributeNameFor("cols"), AttributeDef.CDATA_TYPE, true);
		...
		AttributeDef a_noresize = new AttributeDef(XHTML.attributeNameFor("noresize"), AttributeDef.ENUMERATION_TYPE,
				Arrays.asList(new AttValue[] {
						XHTML.attributeValueFor("noresize")}), false);
		...
		AttributeDef a_rows = new AttributeDef(XHTML.attributeNameFor("rows"), AttributeDef.CDATA_TYPE, false);
		AttributeDef a_rows2 = new AttributeDef(XHTML.attributeNameFor("rows"), AttributeDef.CDATA_TYPE, true);
		...
		addElementType(new ElementType( applet,
				new MixedContentModel(Arrays.asList(new Name[] {
						...
						ol, dl, menu, dir, pre, hr, blockquote, address, center, isindex,
		...
		addElementType(new ElementType( blockquote,
				new MixedContentModel(Arrays.asList(new Name[] {
						...
						dl, menu, dir, pre, hr, blockquote, address, center, isindex, fieldset,
						table, form, a, br, span, bdo, object, applet, img, map,
		...
		addElementType(new ElementType( button,
				new MixedContentModel(Arrays.asList(new Name[] {
						p, h1, h2, h3, h4, h5, h6, div, ul, ol,
						dl, menu, dir, pre, hr, blockquote, address, center, table, br,
						span, bdo, object, applet, img, map, tt, i, b, u,
						s, strike, big, small, font, basefont, em, strong, dfn, code,
						q, samp, kbd, var, cite, abbr, acronym, sub, sup, noscript,
						ins, del, script})),
						Arrays.asList(new AttributeDef[] {
		...
		addElementType(new ElementType( form,
				new MixedContentModel(Arrays.asList(new Name[] {
						p, h1, h2, h3, h4, h5, h6, div, ul, ol,
						dl, menu, dir, pre, hr, blockquote, address, center, isindex, fieldset,
						table, a, br, span, bdo, object, applet, img, map, iframe,
		...
		addElementType(new ElementType( frame,
				ContentModel.EMPTY,
				Arrays.asList(new AttributeDef[] {
						a_class, a_frameborder, a_id, a_longdesc, a_marginheight, a_marginwidth, a_name2,
						a_noresize, a_scrolling, a_src, a_style, a_title}), null));

		addElementType(new ElementType( frameset,
				theGrammarParser.parseGrammar(
				"(frameset|frame|noframes)*"),
				Arrays.asList(new AttributeDef[] {
						a_class, a_cols, a_id, a_onload, a_onunload, a_rows, a_style,
						a_title}), null));
		...
		addElementType(new ElementType( textarea,
				...
				Arrays.asList(new AttributeDef[] {
						a_accesskey, a_class, a_cols2, a_dir, a_disabled, a_id, a_lang,
						a_name, a_onblur, a_onchange, a_onclick, a_ondblclick, a_onfocus, a_onkeydown,
						a_onkeypress, a_onkeyup, a_onmousedown, a_onmousemove, a_onmouseout, a_onmouseover, a_onmouseup,
						a_onselect, a_readonly, a_rows2, a_style, a_tabindex, a_title, a_xml_lang}), null));
