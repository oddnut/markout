 ...
 */
public class XMLChar extends XMLChunk {
	// *** Class Members ***
	...
	public static final XMLChar EQUALS_CHAR = new XMLChar('=');
	public static final XMLChar DOUBLE_QUOTE_CHAR = new XMLChar('"');
	public static final XMLChar SINGLE_QUOTE_CHAR = new XMLChar('\'');
	...
	public boolean equals(Object o) {
		if (o == null || !(o instanceof XMLChar))
			return false;
		return theChar == ((XMLChar)o).theChar;
	}
	...
	public static final boolean isLatinLetterChar(char c) {
		return 
		( c >= '\u0041' && c <= '\u005A' ) ||
		( c >= '\u0061' && c <= '\u007A' );
	}
	
	public static final boolean isLatinDigitChar(char c) {
		return
		( c >= '\u0030' && c <= '\u0039' );
	}
	
	public static final boolean isLetterChar(char c) {
		return isBaseChar(c) || isIdeographicChar(c);
	}
	...
	public static final boolean isIdeographicChar(char c) {
		return 
		( c >= '\u4E00' && c <= '\u9FA5' ) ||
		( c == '\u3007' ) ||
		( c >= '\u3021' && c <= '\u3029' );
	...
	public static final boolean isExtenderChar(char c) {
		return 
		( c == '\u00B7' ) ||
		( c == '\u02D0' ) ||
		( c == '\u02D1' ) ||
	...
	public static final boolean isPublicIDChar(char c) {
		return 
		isLatinLetterChar(c) ||
		isLatinDigitChar(c) ||
		( " \r\n-'()+,./:=?;!*#@$_%".indexOf(c) >= 0 ); // TODO um, pain in ass
		
	}
	
	public static final boolean isEncNameStartChar(char c) {
		return isLatinLetterChar(c);
	}
