...
/**
 * ${docWriterImplClassName}
 * 
 * THIS IS A GENERATED FILE, DO NOT EDIT!
 */
public class ${docWriterImplClassName} extends BasicDocumentWriter implements ${docWriterClassName} {
	// *** Class Members ***
	...
	// *** Constructors ***
	public ${docWriterImplClassName}(EnhancedXMLOutputContext out) {super(out);}
